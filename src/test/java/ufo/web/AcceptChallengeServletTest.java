...
class AcceptChallengeServletTest extends Mockito {
    ...
    public void doPostAnswerTrueTest() throws ServletException, IOException {
        ...
        String expectedNextPage = ACCEPT_CHALLENGE_NEXT_PAGE;
        String expectedAnswerInResponse = ACCEPT_CHALLENGE_ACCEPTED;
    ...
    public void doPostAnswerFalseTest() throws ServletException, IOException {
        ...
        String expectedAnswerInResponse = ACCEPT_CHALLENGE_NOT_ACCEPTED;
